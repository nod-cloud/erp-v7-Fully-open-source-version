<template>
	<div class="guide area">
		...
		<el-tabs v-model="active">
			...
			<el-tab-pane name="retail">
				<template slot="label">
					<span><i class="el-icon-goods"></i> 零售流程</span>
				</template>
				<div class="draw" id="retail">
					<h2>零售业务流程</h2>
					<el-row :gutter="160">
						<el-col :span="8">
							<div class="item" @click="switchPage('vpos')">
								<img src="/static/images/guide/svg/3-0-0.svg">
								<span>零售终端</span>
							</div>
						</el-col>
						<el-col :span="8">
							<div class="item" @click="switchPage('vend')">
								<img src="/static/images/guide/svg/3-0-1.svg">
								<span>常规零售</span>
							</div>
						</el-col>
						<el-col :span="8">
							<div class="item" @click="switchPage('vre')">
								<img src="/static/images/guide/svg/3-0-2.svg">
								<span>零售退货单</span>
							</div>
						</el-col>
						<el-col :span="8">
							<div class="item" @click="switchPage('barter')">
								<img src="/static/images/guide/svg/3-1-0.svg">
								<span>积分兑换单</span>
							</div>
						</el-col>
						<el-col :span="8">
							<div class="item" @click="switchPage('invoice')">
								<img src="/static/images/guide/svg/3-1-1.svg">
								<span>购销发票</span>
							</div>
						</el-col>
						<el-col :span="8">
							<div class="item" @click="switchPage('cost')">
								<img src="/static/images/guide/svg/3-1-2.svg">
								<span>购销费用</span>
							</div>
						</el-col>
					</el-row>
