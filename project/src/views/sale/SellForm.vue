<template>
	<div class="sellForm area">
		...
		<el-table :data="tableData" height="calc(100% - 90px)" @selection-change="selectionChange" border v-madeTable>
			...
			<el-table-column prop="money" label="单据收款" align="center" width="120px"></el-table-column>
		...
		<el-dialog v-if="bills.type=='sor'" class="billDialog" :visible.sync="bills.dialog" title="销售订单详情" :fullscreen="true" >
			<transition name="el-fade-in">
		...
		<el-dialog v-if="bills.type=='sre'" class="billDialog" :visible.sync="bills.dialog" title="销售退货单详情" :fullscreen="true" >
			<transition name="el-fade-in">
				<template v-if="bills.dialog">
