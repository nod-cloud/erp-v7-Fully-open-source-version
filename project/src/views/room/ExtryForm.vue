<template>
	<div class="extryForm area">
		...
		<el-table :data="tableData" height="calc(100% - 90px)" @selection-change="selectionChange" border v-madeTable>
			...
			<el-table-column prop="customerData.name" label="客户" align="center" width="120px"></el-table-column>
	...
	export default {
		...
		methods: {
			...
			downTemplate(){
				...
				setTimeout(() => {
					window.open(this.store.base.cdnSite+"/erp/batch/其它出库单导入模板.xlsx")
				}, 1000);
			},
			//上传模板回调
