<template>
	<div class="billForm area">
		<div class="layout">
			<el-popover ref="searchPopover" popper-class="searchPopover" placement="bottom-start">
				<el-form class="searchFrom" ref="searchFrom"  inline>
					...
					<el-form-item>
						<el-select v-model="searchFrom.type" placeholder="请选择核销类型" clearable>
		...
		<el-table :data="tableData" height="calc(100% - 90px)" @selection-change="selectionChange" border v-madeTable>
			...
			<el-table-column prop="customerData.name" label="客户" align="center" width="150px"></el-table-column>
			...
			<el-table-column prop="extension.type" label="核销类型" align="center" width="150px"></el-table-column>
			<el-table-column prop="pmy" label="核销金额" align="center" width="150px"></el-table-column>
