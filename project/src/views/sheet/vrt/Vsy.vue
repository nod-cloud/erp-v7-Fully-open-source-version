	...
	<div class="vsy area">
		...
		>
			...
			<el-table-column label="零售单" align="center">
				<el-table-column prop="vend.price" label="基础单价" align="center" width="90px"></el-table-column>
				<el-table-column prop="vend.nums" label="数量" align="center" width="90px"></el-table-column>
				<el-table-column prop="vend.money" label="金额" align="center" width="90px"></el-table-column>
			</el-table-column>
			<el-table-column label="零售退货单" align="center">
				<el-table-column prop="vre.price" label="单价" align="center" width="90px"></el-table-column>
				<el-table-column prop="vre.nums" label="数量" align="center" width="90px"></el-table-column>
				<el-table-column prop="vre.money" label="金额" align="center" width="90px"></el-table-column>
			</el-table-column>
			<el-table-column label="积分兑换单" align="center">
				<el-table-column prop="barter.price" label="单价" align="center" width="90px"></el-table-column>
				<el-table-column prop="barter.nums" label="数量" align="center" width="90px"></el-table-column>
				<el-table-column prop="barter.money" label="金额" align="center" width="90px"></el-table-column>
			</el-table-column>
	...
	export default {
		...
		data() {
			return {
				...
				page: {
					...
					count: 5,
					status:[
						{text:'零售总金额',type:'sum',key:'vend.money'},
						{text:'零售退货总金额',type:'sum',key:'vre.money'},
						{text:'积分兑换总金额',type:'sum',key:'barter.money'},
		...
		methods: {
			...
			record(page) {
				...
				this.$axios.post("vrt/vsy", parm).then(result => {
			...
			exports(){
				...
				setTimeout(() => {
					window.open(this.$base.web+'vrt/vsyExports?'+parm)
				}, 1000);
			},
			//页面刷新
			reload() {
