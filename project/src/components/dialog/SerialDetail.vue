<template>
	<div class="serialDetail">
		<el-dialog :visible.sync="dialog" title="序列详情" width="600px" @closed="close" :append-to-body="true" v-madeDialog>
			<el-table :data="tableData" height="320px" border v-madeTable>
				...
				<el-table-column prop="sourceData.number" label="单据编号" align="center" width="200px"></el-table-column>
			</el-table>
