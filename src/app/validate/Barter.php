...
use think\Validate;
class Barter extends Validate {
    
    //常规验证规则
    protected $rule = [
        'customer' => ['require','integer'],
        'time' => ['require','date'],
        'number' => ['require','unique:barter'],
        'total' => ['require','float'],
    ...
    protected $message = [
        ...
        'total.float' => '单据金额不正确!',
        'integral.require' => '单据积分不可为空!',
        'integral.float' => '单据积分不正确!',
        'actual.require' => '实收积分不可为空!',
        'actual.float' => '实收积分不正确!',
    ...
    //场景规则
    protected $scene = [
        'update' => ['customer','time','number','total','integral','actual','people','logistics','file','more']
    ];
}